...
<!-- end bbinclude -->
			...
			<figure>
				<img src="/riders/timothy-chance/mirror.jpg" width="800" height="575" alt="mirror" class="img-thumbnail">
				<figcaption>
					&ldquo;Why it&rsquo;s important to fit a rearview mirror; for the spectacular view, I mean (not because it&rsquo;s the only sight that you&rsquo;ll have of the DF you've passed).&rdquo;
				</figcaption>
			</figure>
<!-- #bbinclude "lcd/lightningriders.incl" -->
			<p class="well">
